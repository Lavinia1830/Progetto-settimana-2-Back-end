    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 col-md-3 col-6 align-self-center text-center py-2">
          <div class="<?php if( get_theme_mod( 'sports_league_display_search', true) == true ) { ?>  <?php } ?> align-self-center">
              <div class="toggle-menu responsive-menu">
                <button role="tab" onclick="sports_league_menu_open()" class="mobiletoggle"><i class="<?php echo esc_attr(get_theme_mod('sports_league_responsive_menu_open_icon','fas fa-bars')); ?>"></i><?php echo esc_html( get_theme_mod('sports_league_open_menu_label', __('Open Menu','sports-league'))); ?><span class="screen-reader-text"><?php esc_html_e('Open Menu','sports-league'); ?></span>
                </button>
              </div>
              <div id="navbar-header" class="menu-brand primary-nav">
                ...
                <a href="javascript:void(0)" class="closebtn responsive-menu" onclick="sports_league_menu_close()"><?php echo esc_html( get_theme_mod('sports_league_close_menu_label', __('Close Menu','sports-league'))); ?><i class="<?php echo esc_attr(get_theme_mod('sports_league_responsive_menu_close_icon','fas fa-times')); ?>"></i><span class="screen-reader-text"><?php esc_html_e('Close Menu','sports-league'); ?></span></a>
              </div>
          </div>
        </div>
        <!-- Search -->
